...
namespace APCSharp.Error
{
    internal static class Error
    {
        ...
        internal static string Unexpected(dynamic got, params Parser.Parser[] parsers) => SyntaxError($"Unexpected '{(got.ToString() as string).ValueToHRT()}' (expected {ToExpected(parsers)})");
